//package simulation;
//
//import local.LocalCorrespondenceRegister;
...
//
//    static Map<Byte, CorrespondenceRegister> correspondences = new HashMap<>();
//
...
//        if (!connected) throw new IllegalStateException();
//        synchronized (Simulation.INSTANCE) {
//            correspondences.put(nextId, LocalCorrespondenceRegister.to(nextId));
//            return nextId++;
//        }
//    }
//
